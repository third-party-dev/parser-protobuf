...
def register_pparse_pickle(subparsers: Any) -> None:
    ...
    pickle_subparser = pickle_parser.add_subparsers(dest="pickle_command", required=True)

    pickle_parse_parser = pickle_subparser.add_parser("view", help="pickle parse command")
