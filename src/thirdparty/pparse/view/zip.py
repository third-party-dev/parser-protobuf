...
class Zip:
    ...
    def _parse(
        self, data_source: Any, fname: str = "unnamed.zip", recursion: Optional[pparse.RecursionControl] = None
    ) -> Zip:
    ...
    def from_bytesio(
        self, bytes_io: Any, fname: str = "unnamed.zip", recursion: Optional[pparse.RecursionControl] = None
    ) -> Zip:
