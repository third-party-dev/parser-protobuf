...
class TFLite:
    ...
    def _parse(
        self, data_source: Any, fname: str = "unnamed.tflite", recursion: Optional[pparse.RecursionControl] = None
    ) -> TFLite:
    ...
    def from_bytesio(
        self, bytes_io: Any, fname: str = "unnamed.tflite", recursion: Optional[pparse.RecursionControl] = None
    ) -> TFLite:
