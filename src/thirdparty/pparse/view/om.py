...
class Om:
    ...
    def open_fpath(
        self, fpath: str, recursion: Optional[pparse.RecursionControl] = None, header_only: bool = False
    ) -> Om:
    ...
    def from_bytesio(
        ...
        return self._parse(
            pparse.BytesIoData(bytes_io=bytes_io), recursion=recursion, header_only=header_only, fname=fname
        )
