...
class MNN:
    ...
    def _parse(
        self, data_source: Any, fname: str = "unnamed.mnn", recursion: Optional[pparse.RecursionControl] = None
    ) -> MNN:
    ...
    def from_bytesio(
        self, bytes_io: Any, fname: str = "unnamed.mnn", recursion: Optional[pparse.RecursionControl] = None
    ) -> MNN:
